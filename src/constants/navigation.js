import {
  LayoutDashboard, Building2, HardHat, ClipboardList, ShieldCheck, DraftingCompass,
  Hammer, Cable, Users2, CalendarDays, FileText, PencilRuler, Boxes, Warehouse,
  Truck, Store, Microscope, Landmark, UserCog, ListChecks, BarChart3,
  Bell, ScrollText, Settings, LifeBuoy, Activity,
} from "lucide-react";
...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/societies", label: "Societies", icon: Landmark },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/drawings", label: "Drawings & Approvals", icon: PencilRuler },
